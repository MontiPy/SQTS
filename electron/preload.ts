...
const api = {
  ...
  supplierInstances: {
    ...
    updateNmrRank: (supplierProjectId: number, nmrRank: string | null) => ipcRenderer.invoke('supplier-instances:update-nmr-rank', supplierProjectId, nmrRank),
    evaluateApplicability: (projectId: number, supplierId: number, nmrRankOverride?: string | null) => ipcRenderer.invoke('supplier-instances:evaluate-applicability', projectId, supplierId, nmrRankOverride),
